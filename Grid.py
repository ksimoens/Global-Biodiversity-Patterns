...
class Grid():
	...
	def getNeighbours(self,index):
		...
		if(index >= len(self.global_grid)-Nlon and (index) % Nlon == 0):
			...
			print(Nlon - 1 - (index - (Nlon*Nlat-Nlon) ))
		# | - - . - - |
		# | o - . - - |
		# | - - . - x |
